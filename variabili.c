#include <stdio.h>
/* Variabili
* int= numero -> 4 byte -> 32 bit, ovvero 4.294.967.296 valori tra - 2.147.483.648 e 2.147.483.647
...
* char e' il crattere composto da 1 byte -> 8 bit -> 256 valori massimi -> 128 usati in realta' 
*/
 int main(){
    int primo_numero;
    int secondo_numero;
    ...
    printf(" Inseriisci il secondo numero\n");
